...
[![Tests](https://img.shields.io/badge/tests-850-brightgreen?style=flat-square)](tests)
...
**11** commands · **22** modules · **850** tests · **97%** coverage · **zero** runtime dependencies · **byte-reproducible** images
...
|:------|:--------|:-------|
| Everything | `pytest` | 850 tests, coverage gate at 95% |
