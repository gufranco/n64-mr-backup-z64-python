...
[![Tests](https://img.shields.io/badge/tests-839-brightgreen?style=flat-square)](tests)
...
**11** commands · **22** modules · **839** tests · **97%** coverage · **zero** runtime dependencies · **byte-reproducible** images
...
|:------|:--------|:-------|
| Everything | `pytest` | 839 tests, coverage gate at 95% |
